...
<div class="container py-4">
    <div class="mb-3">
        <a href="{{ route('admin.pencarian-sekolah.index') }}" class="btn btn-outline-secondary">
            <i class="fas fa-arrow-left me-1"></i> Kembali
        </a>
        <a href="{{ route('admin.pencarian-sekolah.edit', $school) }}" class="btn btn-warning text-white ms-2">
            <i class="fas fa-edit me-1"></i> Edit
        </a>
        <form action="{{ route('admin.pencarian-sekolah.destroy', $school) }}" method="POST" class="d-inline">
            @csrf
            @method('DELETE')
            <button type="submit" class="btn btn-danger ms-2"
                onclick="return confirm('Apakah Anda yakin ingin menghapus perguruan tinggi ini?')">
