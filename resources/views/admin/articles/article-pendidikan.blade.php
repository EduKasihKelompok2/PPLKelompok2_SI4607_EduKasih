@extends('layouts.app')
@section('title', 'Kelola Artikel Pendidikan')
@push('styles')
...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1>Kelola Artikel Pendidikan</h1>
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body">
            <form action="{{ route('admin.articles.pendidikan') }}" method="GET">
                        ...
                        <tr>
                            <td colspan="5" class="text-center py-4">
                                <div class="alert alert-info mb-0">
                                    <i class="fas fa-info-circle me-2"></i> Tidak ada artikel pendidikan
                                </div>
                            </td>
                        </tr>
                        @endforelse
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addArticleModalLabel">Tambah Artikel Pendidikan</h5>
