...
@section('title', 'Artikel Pendidikan')
...
<div class="container py-5">
    ...
    <div class="search-container shadow-sm">
        <form action="{{ route('articles.pendidikan') }}" method="GET">
            <div class="input-group">
                <input type="text" class="form-control" name="search" placeholder="Cari artikel pendidikan..."
    ...
    <div class="alert alert-info">
        <i class="fas fa-info-circle me-2"></i> Belum ada artikel pendidikan yang tersedia.
    </div>
    @else
    <div class="row g-4">
